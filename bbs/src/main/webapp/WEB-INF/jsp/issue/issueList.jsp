...
<head>
    ...
    <style type="text/css">
        ...
        a.issue{color:blue;text-decoration: none;}
        a.issue:hover {color:orange;text-decoration: underline;}
...
<div>
    ...
    <div align="center">
        <p><a class ="commonHref" href="/issue/toPublish/${columnBelong}">我要发帖</a><p/>
    </div>
</div>
</body>
</html>
